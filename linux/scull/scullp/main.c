 ...
 */
static int scullp_io_primitive(int write, struct kiocb *iocb,
                           ...
                           unsigned long nr_segs, loff_t pos)
{
	...
	/* Copy now while we can access the buffer */
        result = scullp_io_primitive(write, iocb, iov, nr_segs, pos);
...
/* static ssize_t scullp_aio_read
