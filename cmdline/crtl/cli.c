...
struct cli_optarg {
    ...
    int (*get_completions)(struct cli_struct *, const char *, const char *, struct cli_comphelp *);
    int (*validator)(struct cli_struct *, const char *, const char *);
...
struct cli_command {
    char *command;
    int (*callback)(struct cli_struct *, const char *, char **, int);
    unsigned int unique_len;
    char *help;
    int privilege;
    int mode;
    ...
    int (*filter)(struct cli_struct *cli, const char *string, void *data);
...
struct cli_struct {
    ...
    void (*print_callback)(struct cli_struct *cli, const char *string);
    FILE *client;
    /* internal buffers */
    void *conn;
    void *service;
    ...
    time_t idle_timeout;
    int (*idle_timeout_callback)(struct cli_struct *);
    time_t last_action;
    int telnet_protocol;
    void *user_context;
    struct cli_optarg_pair *found_optargs;
...
static int cli_search_flags_validator(struct cli_struct *cli, const char *word, const char *value);
static int cli_match_filter_init(struct cli_struct *cli, int argc, char **argv, struct cli_filter *filt);
static int cli_range_filter_init(struct cli_struct *cli, int argc, char **argv, struct cli_filter *filt);
static int cli_count_filter_init(struct cli_struct *cli, int argc, char **argv, struct cli_filter *filt);
static int cli_match_filter(struct cli_struct *cli, const char *string, void *data);
static int cli_range_filter(struct cli_struct *cli, const char *string, void *data);
static int cli_count_filter(struct cli_struct *cli, const char *string, void *data);
static void cli_int_parse_optargs(struct cli_struct *cli, struct cli_pipeline_stage *stage, struct cli_command *cmd,
                                  char lastchar, struct cli_comphelp *comphelp);
static int cli_int_enter_buildmode(struct cli_struct *cli, struct cli_pipeline_stage *stage, char *mode_text);
static char *cli_int_buildmode_extend_cmdline(char *, char *word);
static void cli_int_free_buildmode(struct cli_struct *cli);
static void cli_free_command(struct cli_struct *cli, struct cli_command *cmd);
static int cli_int_unregister_command_core(struct cli_struct *cli, const char *command, int command_type);
static int cli_int_unregister_buildmode_command(struct cli_struct *cli, const char *command) __attribute__((unused));
static struct cli_command *cli_int_register_buildmode_command(
                struct cli_struct *cli, struct cli_command *parent, const char *command,
                int (*callback)(struct cli_struct *cli, const char *, char **, int), int privilege, int mode, const char *help);
static int cli_int_buildmode_cmd_cback(struct cli_struct *cli, const char *command, char *argv[], int argc);
static int cli_int_buildmode_flag_cback(struct cli_struct *cli, const char *command, char *argv[], int argc);
static int cli_int_buildmode_flag_multiple_cback(struct cli_struct *cli, const char *command, char *argv[], int argc);
static int cli_int_buildmode_cancel_cback(struct cli_struct *cli, const char *command, char *argv[], int argc);
static int cli_int_buildmode_exit_cback(struct cli_struct *cli, const char *command, char *argv[], int argc);
static int cli_int_buildmode_show_cback(struct cli_struct *cli, const char *command, char *argv[], int argc);
static int cli_int_buildmode_unset_cback(struct cli_struct *cli, const char *command, char *argv[], int argc);
static int cli_int_buildmode_unset_completor(struct cli_struct *cli, const char *name, const char *word,
                                             struct cli_comphelp *comphelp);
static int cli_int_buildmode_unset_validator(struct cli_struct *cli, const char *name, const char *value);
static int cli_int_execute_buildmode(struct cli_struct *cli);
static void cli_int_free_found_optargs(struct cli_optarg_pair **optarg_pair);
static void cli_int_unset_optarg_value(struct cli_struct *cli, const char *name);
static struct cli_pipeline *cli_int_generate_pipeline(struct cli_struct *cli, const char *command);
static int cli_int_validate_pipeline(struct cli_struct *cli, struct cli_pipeline *pipeline);
static int cli_int_execute_pipeline(struct cli_struct *cli, struct cli_pipeline *pipeline);
inline void cli_int_show_pipeline(struct cli_struct *cli, struct cli_pipeline *pipeline);
static void cli_int_free_pipeline(struct cli_pipeline *pipeline);
static void cli_register_command_core(struct cli_struct *cli, struct cli_command *parent, struct cli_command *c);
...
char *cli_command_name(struct cli_struct *cli, struct cli_command *command) 
{
    char *name;
    char *o;
...
static int cli_build_shortest(struct cli_struct *cli, struct cli_command *commands) 
{
...
int cli_set_privilege(struct cli_struct *cli, int priv) 
{
    ...
    if (priv != old) 
    {
        cli_set_promptchar(cli, priv == CLI_PRIVILEGE_PRIVILEGED ? "# " : "$ ");
...
void cli_register_command_core(struct cli_struct *cli, struct cli_command *parent, struct cli_command *c) 
{
...
struct cli_command *cli_register_command(struct cli_struct *cli, struct cli_command *parent, const char *command,
                                         int (*callback)(struct cli_struct *cli, const char *, char **, int),
...
int cli_int_unregister_command_core(struct cli_struct *cli, const char *command, int command_type) 
{
...
int cli_show_help(struct cli_struct *cli, struct cli_command *c) 
{
    ...
    for (p = c; p; p = p->next) 
    {
        ...
        {
            cli_error(cli, "  %-20s %s", cli_command_name(cli, p), (p->help != NULL ? p->help : "No help line"));
        }
...
int cli_int_enable(struct cli_struct *cli, const char _unused *command, char _unused *argv[], int _unused argc) 
{
    ...
    if (!cli->enable_password && !cli->enable_callback) 
    {
        ...
        cli_set_privilege(cli, CLI_PRIVILEGE_PRIVILEGED);
        cli_set_configmode(cli, CLI_MODE_EXEC, NULL);
    } 
    else 
    {
        // Require password entry
        fprintf(stderr, "Require privileged commands.\n");
        cli_print(cli, "notice: %s", cli_enable_password);
...
int cli_int_disable(struct cli_struct *cli, const char _unused *command, char _unused *argv[], int _unused argc) 
{
    cli_set_privilege(cli, CLI_PRIVILEGE_UNPRIVILEGED);
    cli_set_configmode(cli, CLI_MODE_EXEC, NULL);
    return CLI_OK;
}

int cli_int_help(struct cli_struct *cli, const char _unused *command, char _unused *argv[], int _unused argc) 
{
    cli_error(cli, "\nCommands available:");
...
int cli_int_history(struct cli_struct *cli, const char _unused *command, char _unused *argv[], int _unused argc) 
{
    int i;
...
int cli_int_quit(struct cli_struct *cli, const char _unused *command, char _unused *argv[], int _unused argc) 
{
    cli_set_privilege(cli, CLI_PRIVILEGE_UNPRIVILEGED);
    cli_set_configmode(cli, CLI_MODE_EXEC, NULL);
    return CLI_QUIT;
...
int cli_int_exit(struct cli_struct *cli, const char *command, char *argv[], int argc) 
{
...
int cli_int_idle_timeout(struct cli_struct *cli) 
{
    cli_print(cli, "Idle timeout");
    return CLI_QUIT;
}

int cli_int_configure_terminal(struct cli_struct *cli, const char _unused *command, char _unused *argv[], int _unused argc) 
{
    cli_set_configmode(cli, CLI_MODE_CONFIG, NULL);
    return CLI_OK;
}
...
struct cli_struct *cli_init(const char *banner, const char *hostname) 
{
    ...
    if (!(cli = calloc(sizeof(struct cli_struct), 1))) return 0;
    ...
    cli_register_command(cli, 0, "ls", cli_int_help, CLI_PRIVILEGE_UNPRIVILEGED, CLI_MODE_ANY, "Show available commands");
    cli_register_command(cli, 0, "quit", cli_int_quit, CLI_PRIVILEGE_UNPRIVILEGED, CLI_MODE_ANY, "Disconnect");
    cli_register_command(cli, 0, "logout", cli_int_quit, CLI_PRIVILEGE_UNPRIVILEGED, CLI_MODE_ANY, "Disconnect");
    cli_register_command(cli, 0, "exit", cli_int_exit, CLI_PRIVILEGE_UNPRIVILEGED, CLI_MODE_ANY, "Exit from current mode");
    cli_register_command(cli, 0, "history", cli_int_history, CLI_PRIVILEGE_UNPRIVILEGED, CLI_MODE_ANY,"Show a list of previously run commands");
    cli_register_command(cli, 0, "enable", cli_int_enable, CLI_PRIVILEGE_UNPRIVILEGED, CLI_MODE_EXEC,"Turn on privileged commands");
    cli_allow_enable(cli, cli_enable_password);
    
    cli_register_command(cli, 0, "disable", cli_int_disable, CLI_PRIVILEGE_PRIVILEGED, CLI_MODE_EXEC,"Turn off privileged commands");

    c = cli_register_command(cli, 0, "configure", 0, CLI_PRIVILEGE_PRIVILEGED, CLI_MODE_EXEC, "Enter configuration mode");
    cli_register_command(cli, c, "terminal", cli_int_configure_terminal, CLI_PRIVILEGE_PRIVILEGED, CLI_MODE_EXEC,"Configure from the terminal");

    // And now the built in filters
    c = cli_register_filter(cli, "begin", cli_range_filter_init, cli_range_filter, CLI_PRIVILEGE_UNPRIVILEGED, CLI_MODE_ANY,"Begin with lines that match");
    cli_register_optarg(c, "range_start", CLI_CMD_ARGUMENT | CLI_CMD_REMAINDER_OF_LINE, CLI_PRIVILEGE_UNPRIVILEGED, CLI_MODE_ANY,"Begin showing lines that match", NULL, NULL, NULL);

    c = cli_register_filter(cli, "between", cli_range_filter_init, cli_range_filter, CLI_PRIVILEGE_UNPRIVILEGED, CLI_MODE_ANY, "Between lines that match");
    cli_register_optarg(c, "range_start", CLI_CMD_ARGUMENT, CLI_PRIVILEGE_UNPRIVILEGED, CLI_MODE_ANY,"Begin showing lines that match", NULL, NULL, NULL);
    cli_register_optarg(c, "range_end", CLI_CMD_ARGUMENT | CLI_CMD_REMAINDER_OF_LINE, CLI_PRIVILEGE_UNPRIVILEGED, CLI_MODE_ANY,"Stop showing lines that match", NULL, NULL, NULL);

    cli_register_filter(cli, "count", cli_count_filter_init, cli_count_filter, CLI_PRIVILEGE_UNPRIVILEGED, CLI_MODE_ANY,"Count of lines");

    c = cli_register_filter(cli, "exclude", cli_match_filter_init, cli_match_filter, CLI_PRIVILEGE_UNPRIVILEGED, CLI_MODE_ANY,"Exclude lines that match");
    cli_register_optarg(c, "search_pattern", CLI_CMD_ARGUMENT | CLI_CMD_REMAINDER_OF_LINE, CLI_PRIVILEGE_UNPRIVILEGED,CLI_MODE_ANY, "Search pattern", NULL, NULL, NULL);

    c = cli_register_filter(cli, "include", cli_match_filter_init, cli_match_filter, CLI_PRIVILEGE_UNPRIVILEGED, CLI_MODE_ANY,"Include lines that match");
    cli_register_optarg(c, "search_pattern", CLI_CMD_ARGUMENT | CLI_CMD_REMAINDER_OF_LINE, CLI_PRIVILEGE_UNPRIVILEGED,CLI_MODE_ANY, "Search pattern", NULL, NULL, NULL);

    c = cli_register_filter(cli, "grep", cli_match_filter_init, cli_match_filter, CLI_PRIVILEGE_UNPRIVILEGED, CLI_MODE_ANY,"Include lines that match regex (options: -v, -i, -e)");
    cli_register_optarg(c, "search_flags", CLI_CMD_HYPHENATED_OPTION, CLI_PRIVILEGE_UNPRIVILEGED, CLI_MODE_ANY,"Search flags (-[ivx]", NULL, cli_search_flags_validator, NULL);
    cli_register_optarg(c, "search_pattern", CLI_CMD_ARGUMENT | CLI_CMD_REMAINDER_OF_LINE, CLI_PRIVILEGE_UNPRIVILEGED,CLI_MODE_ANY, "Search pattern", NULL, NULL, NULL);
    
    c = cli_register_filter(cli, "egrep", cli_match_filter_init, cli_match_filter, CLI_PRIVILEGE_UNPRIVILEGED, CLI_MODE_ANY,"Include lines that match extended regex");
    cli_register_optarg(c, "search_flags", CLI_CMD_HYPHENATED_OPTION, CLI_PRIVILEGE_UNPRIVILEGED, CLI_MODE_ANY,"Search flags (-[ivx]", NULL, cli_search_flags_validator, NULL);
    cli_register_optarg(c, "search_pattern", CLI_CMD_ARGUMENT | CLI_CMD_REMAINDER_OF_LINE, CLI_PRIVILEGE_UNPRIVILEGED,CLI_MODE_ANY, "Search pattern", NULL, NULL, NULL);

    cli->privilege = cli->mode = -1;
    cli_set_privilege(cli, CLI_PRIVILEGE_UNPRIVILEGED);
    cli_set_configmode(cli, CLI_MODE_EXEC, 0);
...
void cli_unregister_tree(struct cli_struct *cli, struct cli_command *command, int command_type) 
{
    struct cli_command *c, *p = NULL;
...
static int cli_add_history(struct cli_struct *cli, const char *cmd) 
{
    int i;
    for (i = 0; i < CLI_MAX_HISTORY; i++) {
        if (!cli->history[i]) {
...
int cli_run_command(struct cli_struct *cli, const char *command) 
{
    ...
    if (pipeline) 
        rc = cli_int_validate_pipeline(cli, pipeline);
...
void cli_get_completions(struct cli_struct *cli, const char *command, char lastchar, struct cli_comphelp *comphelp) 
{
    ...
    if (!(pipeline = cli_int_generate_pipeline(cli, command))) 
        goto out;
...
static int show_prompt(struct cli_struct *cli, int sockfd) {
  int len = 0;
...
static void _print(struct cli_struct *cli, int print_mode, const char *format, va_list ap) {
  int n;
  char *p = NULL;
  ...
  do {
    char *next = strchr(p, '\n');
    struct cli_filter *f = (print_mode & CLI_PRINT_FILTERED) ? cli->filters : 0;
    int print = 1;
...
void cli_bufprint(struct cli_struct *cli, const char *format, ...) {
  va_list ap;
...
void cli_print(struct cli_struct *cli, const char *format, ...) {
  va_list ap;
...
void cli_error(struct cli_struct *cli, const char *format, ...) {
  va_list ap;
...
int cli_search_flags_validator(struct cli_struct *cli, const char *word, const char *value) {
...
int cli_match_filter_init(struct cli_struct *cli, int argc, char **argv, struct cli_filter *filt) {
...
int cli_match_filter(struct cli_struct _unused *cli, const char *string, void *data) 
{
...
int cli_range_filter_init(struct cli_struct *cli, int argc, char **argv, struct cli_filter *filt) {
...
int cli_range_filter(struct cli_struct _unused *cli, const char *string, void *data) 
{
...
int cli_count_filter_init(struct cli_struct *cli, int argc, char _unused **argv, struct cli_filter *filt) 
{
  if (argc > 1) {
...
int cli_count_filter(struct cli_struct *cli, const char *string, void *data) {
  int *count = data;
...
struct cli_command *cli_register_filter(struct cli_struct *cli, const char *command,
                                        int (*init)(struct cli_struct *cli, int, char **, struct cli_filter *),
...
int cli_register_optarg(struct cli_command *cmd, const char *name, int flags, int privilege, int mode, const char *help,
                        ...
                        int (*transient_mode)(struct cli_struct *cli, const char *, const char *)) {
  struct cli_optarg *optarg;
...
void cli_int_unset_optarg_value(struct cli_struct *cli, const char *name) {
...
void cli_int_free_buildmode(struct cli_struct *cli) {
...
int cli_int_enter_buildmode(struct cli_struct *cli, struct cli_pipeline_stage *stage, char *mode_text) {
  struct cli_optarg *optarg;
  struct cli_command *c;
  struct cli_buildmode *buildmode;
  ...
  cli_int_register_buildmode_command(cli, NULL, "cancel", cli_int_buildmode_cancel_cback, CLI_PRIVILEGE_UNPRIVILEGED,
                                     cli->mode, "Cancel command");
  cli_int_register_buildmode_command(cli, NULL, "exit", cli_int_buildmode_exit_cback, CLI_PRIVILEGE_UNPRIVILEGED, cli->mode,
                                     "Exit and execute command");
  cli_int_register_buildmode_command(cli, NULL, "show", cli_int_buildmode_show_cback, CLI_PRIVILEGE_UNPRIVILEGED, cli->mode,
                                     "Show current settings");
  c = cli_int_register_buildmode_command(cli, NULL, "unset", cli_int_buildmode_unset_cback, CLI_PRIVILEGE_UNPRIVILEGED,
                                         cli->mode, "Unset a setting");
  cli_register_optarg(c, "setting", CLI_CMD_ARGUMENT | CLI_CMD_DO_NOT_RECORD, CLI_PRIVILEGE_UNPRIVILEGED, cli->mode,
...
int cli_int_unregister_buildmode_command(struct cli_struct *cli, const char *command) {
  return cli_int_unregister_command_core(cli, command, CLI_BUILDMODE_COMMAND);
}

struct cli_command *cli_int_register_buildmode_command(struct cli_struct *cli, struct cli_command *parent,
                                                       const char *command,
                                                       int (*callback)(struct cli_struct *cli, const char *, char **, int),
                                                       int privilege, int mode, const char *help) {
  struct cli_command *c;
...
int cli_int_execute_buildmode(struct cli_struct *cli) {
...
int cli_int_buildmode_cmd_cback(struct cli_struct *cli, const char *command, char *argv[], int argc) {
...
int cli_int_buildmode_flag_cback(struct cli_struct *cli, const char *command, char *argv[], int argc) {
  int rc = CLI_BUILDMODE_EXTEND;
...
// A 'flag' callback has no optargs, so we need to set it ourself based on *this* command
int cli_int_buildmode_flag_multiple_cback(struct cli_struct *cli, const char *command, char *argv[], int argc) {
  int rc = CLI_BUILDMODE_EXTEND;
...
int cli_int_buildmode_cancel_cback(struct cli_struct *cli, const char *command, char *argv[], int argc) {
...
int cli_int_buildmode_exit_cback(struct cli_struct *cli, const char *command, char *argv[], int argc) {
...
int cli_int_buildmode_show_cback(struct cli_struct *cli, const char *command, char *argv[], int argc) {
  struct cli_optarg_pair *optarg_pair;
...
int cli_int_buildmode_unset_cback(struct cli_struct *cli, const char *command, char *argv[], int argc) {
...
int cli_int_buildmode_unset_completor(struct cli_struct *cli, const char *name, const char *word,
                                      struct cli_comphelp *comphelp) {
  return CLI_OK;
}

int cli_int_buildmode_unset_validator(struct cli_struct *cli, const char *name, const char *value) {
  return CLI_OK;
}
...
static int cli_int_locate_command(struct cli_struct *cli, struct cli_command *commands, int command_type, int start_word,
                                  struct cli_pipeline_stage *stage) {
...
int cli_int_validate_pipeline(struct cli_struct *cli, struct cli_pipeline *pipeline) {
  int i;
  int rc = CLI_OK;
  int command_type;
...
void cli_int_show_pipeline(struct cli_struct *cli, struct cli_pipeline *pipeline) {
  int i, j;
  struct cli_pipeline_stage *stage;
  char **word;
  struct cli_optarg_pair *optarg_pair;
...
struct cli_pipeline *cli_int_generate_pipeline(struct cli_struct *cli, const char *command) {
  int i;
  struct cli_pipeline_stage *stage;
  char **word;
  struct cli_pipeline *pipeline = NULL;
...
int cli_int_execute_pipeline(struct cli_struct *cli, struct cli_pipeline *pipeline) {
  int stage_num;
  int rc = CLI_OK;
...
static void cli_get_optarg_comphelp(struct cli_struct *cli, struct cli_optarg *optarg, struct cli_comphelp *comphelp,
  ...
  int (*get_completions)(struct cli_struct *, const char *, const char *, struct cli_comphelp *) = NULL;
  char *tptr = NULL;
  char *tname = NULL;
...
static void cli_int_parse_optargs(struct cli_struct *cli, struct cli_pipeline_stage *stage, struct cli_command *cmd,
  ...
  int is_last_word = 0;
  int (*validator)(struct cli_struct *, const char *name, const char *value);
