...
static struct trace trace = { .args = STAILQ_HEAD_INITIALIZER(trace.args), .status=1};
...
//        RTE_DEBUG("invalid arguments.\n");
	...
	register_fn();
//    RTE_DEBUG("register_fn %s called.\n", name);
