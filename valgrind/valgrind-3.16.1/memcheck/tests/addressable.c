...
static char *my_mmap(char *addr, int size, int prot)
{
...
static void test1()
{
	char *m = my_mmap(0, pgsz * 5, PROT_READ);
...
static void test2()
{
	char *m = my_mmap(0, pgsz * 5, PROT_READ|PROT_WRITE);
