...
//==127787== Jump to the invalid address stated on the next line
//==127787==    at 0x0: ???
//==127787==    by 0x4E58554: (below main) (in /usr/lib64/libc-2.17.so)
//==127787==  Address 0x0 is not stack'd, malloc'd or (recently) free'd
//==127787== 
