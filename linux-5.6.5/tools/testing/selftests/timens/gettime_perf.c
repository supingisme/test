...
//[rongtao@localhost timens]$ ./gettime_perf.out 
//1..8
//ok 1 host:	clock:  monotonic	cycles:	 119078771
//ok 2 host:	clock: monotonic-coarse	cycles:	 558568515
//ok 3 host:	clock: monotonic-raw	cycles:	 115779264
//ok 4 host:	clock:   boottime	cycles:	 115265060
//ok 6 # SKIP need to run as root
//# Planned tests != run tests (8 != 5)
