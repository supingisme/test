...
void _start(void)
{
	...
	print(" ---\n");
	print_k_value(" RAM Total:  ", info.totalram, info.mem_unit);
	print_k_value(" RAM Free:   ", info.freeram, info.mem_unit);
	print_k_value(" RAM Buffer: ", info.bufferram, info.mem_unit);
	print_k_value(" RAM In use: ", used, info.mem_unit);
	print(" ...\n");
	print("1..1\n");
